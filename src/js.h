...
typedef struct nd_js_drag_session nd_js_drag_session;
...
gboolean nd_js_in_pump(const nd_js *js);
...
void nd_js_request_repaint(nd_js *js);
...
gboolean nd_js_dispatch_mouse_event(nd_js *js, const nd_node *target,
                                    const char *type,
...
nd_js_drag_session *nd_js_drag_session_new(nd_js *js);
void                nd_js_drag_session_free(nd_js_drag_session *session);
void                nd_js_drag_session_set_data(nd_js_drag_session *session,
                                                const char *type,
                                                const char *data);
gboolean            nd_js_dispatch_drag_event(nd_js *js, nd_js_drag_session *session,
...
gboolean nd_js_dispatch_wheel_event(nd_js *js, const nd_node *target,
                                    double client_x, double client_y,
                                    double page_x, double page_y,
