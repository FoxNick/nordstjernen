...
static const char k_about_start_template[] =
    ...
    ".logo { width: 52px; height: 52px; display:inline-block;"
    " vertical-align:middle; margin-right:14px; border-radius: 12px; }\n"
    ".hgroup { display:inline-block; vertical-align:middle; text-align:left; }\n"
    ...
    " margin:6px 2px 0 2px; font-size:0.9em; line-height:1.45;"
    " flex:0 0 auto; }\n"
    ...
    "<div class=\"msg bot\">Hi! I'm a small language model running entirely "
    "on your own computer through llama.cpp \xe2\x80\x94 your questions never "
    "leave this machine, and there's no cloud or sign-in. Ask me anything, and "
    "I can also search the web or open pages for you. Try \xe2\x80\x9cwho was "
    "Ada Lovelace?\xe2\x80\x9d, \xe2\x80\x9cshow me an image of the "
    "pyramids\xe2\x80\x9d, \xe2\x80\x9csearch for climate news\xe2\x80\x9d, or "
    "\xe2\x80\x9cgo to wikipedia.org\xe2\x80\x9d.</div>"
    "</div>"
...
static const char k_about_start_template[] =
    ...
    ".wrap { max-width: 760px; margin: 0 auto; padding: 44px 24px 32px;"
    " box-sizing:border-box; }\n"
    ".head { text-align:center; margin-bottom:22px; }\n"
    ".logo { width: 58px; height: 58px; display:inline-block;"
    " vertical-align:middle; margin-right:14px; border-radius: 12px; }\n"
    ".hgroup { display:inline-block; vertical-align:middle; text-align:left; }\n"
    ".title { font-size: 1.55em; font-weight: 600; white-space:nowrap; }\n"
    ...
    "@media (max-width:560px) { .wrap { padding-top:26px; }"
    " .head { text-align:left; } .logo { margin-right:10px; }"
    " .title { font-size:1.28em; } .search { flex-direction:column; }"
    " .search button { width:100%; } }\n"
    "</style></head>"
    "<body><main class=\"wrap\">"
    "<div class=\"head\">"
    "<img class=\"logo\" alt=\"Nordstjernen\" width=\"58\" height=\"58\""
    " src=\"__ND_LOGO_URI__\">"
    "<div class=\"hgroup\"><div class=\"title\">Nordstjernen " NS_VERSION
    "</div><div class=\"tagline\">__ND_TAGLINE__</div></div>"
    "</div>"
