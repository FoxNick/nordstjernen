...
".bar{display:flex;align-items:center;padding:11px 18px;"
"background:#1b2a4a;color:#fff;position:sticky;top:0;z-index:5}\n"
".brand{font-weight:700;font-size:1.12em;margin-right:16px}\n"
".who{color:#b9c6e0;font-size:.9em;flex:1 1 auto}\n"
".bar .actions{display:flex;flex:0 0 auto}\n"
".bar .actions button{margin-left:8px}\n"
