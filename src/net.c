...
static const char k_about_start_template[] =
    ...
    " margin:10px auto 16px auto; flex:0 0 auto; }\n"
    ...
    " cursor:pointer; }\n"
    ".intro { color:#8b93a3; text-align:center; max-width:560px;"
    " margin:18px auto 0 auto; font-size:0.9em; line-height:1.5;"
    " flex:0 0 auto; }\n"
    "</style></head>"
    "<body>"
    "<div class=\"wrap\">"
    ...
    "<div class=\"hgroup\"><div class=\"title\">Nordstjernen AI " NS_VERSION
    ...
    "<input id=\"q\" autocomplete=\"off\" size=\"48\""
    ...
    "      ig.className='genimg'; ig.src=u; el.appendChild(ig);}\n"
