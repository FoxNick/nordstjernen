...
static const char k_about_start_template[] =
    ...
    "cloud. Ask me anything, or try \xe2\x80\x9cwho is Ada Lovelace\xe2\x80\x9d, "
    "\xe2\x80\x9cshow me an image of the pyramids\xe2\x80\x9d, \xe2\x80\x9csearch "
    "for climate news\xe2\x80\x9d, or \xe2\x80\x9cgo to wikipedia.org\xe2\x80\x9d."
    "</div>"
    "</div>"
                          ...
                          ns_response *resp)
{
    ...
    if (g_str_equal(what, "blank") || g_str_equal(what, "")) {
        ...
        const char *search_name = engine_host && *engine_host
