...
static const char k_about_start_template[] =
    ...
    " padding:10px 12px; background:#0e1116; border:1px solid #2a313c;"
    " border-radius:10px; }\n"
    ".opt.active { border-color:#2d6cf6; }\n"
    ".opt .name { font-weight:600; }\n"
    ".opt .sz { color:#8b93a3; font-size:0.85em; }\n"
    ".opt .spacer { flex:1 1 auto; }\n"
    ".opt button { margin:0; padding:7px 14px; font-size:0.9em; }\n"
    ".opt .badge { color:#5b8dff; font-size:0.85em; font-weight:600; }\n"
    ".change { margin-left:8px; color:#fff; cursor:pointer; border:0;"
    " background:#000; font:inherit; padding:2px 8px; border-radius:6px;"
    ...
    ".search input { flex:1 1 auto; border:1px solid #2a313c;"
    " background:#161b22; color:#e6e9ef; border-radius:10px;"
    ...
    " cursor:pointer; }\n"
    ".intro { color:#8b93a3; text-align:left;"
    ...
    "   renderMsg(t,txt);}).catch(function(err){\n"
