...
nd_css_stylesheet *nd_css_stylesheet_from_style_element(nd_node *style);
nd_css_stylesheet *nd_css_stylesheet_from_style_element_cached(nd_node *style);
char              *nd_css_style_element_text(nd_node *style);
nd_css_stylesheet *nd_css_merged_styles_cached(const char *css, gssize len);
nd_css_stylesheet *nd_css_stylesheet_parse_url_cached(const char *url,
                                                      const char *css,
                                                      gssize len);
void               nd_css_style_element_cache_begin(void);
...
typedef struct nd_style {
    ...
    struct nd_var_map *vars;
} nd_style;

const char *nd_var_map_lookup(const struct nd_var_map *m, const char *name);
