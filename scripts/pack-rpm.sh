...
# window (StartupWMClass=com.nordstjernen.Browser) to its desktop file.
install -m644 %{SOURCE2} %{buildroot}%{_datadir}/applications/com.nordstjernen.Browser.desktop
...
%{_datadir}/applications/com.nordstjernen.Browser.desktop
