...
stage_stable_links() {
    ...
    link_stable nordstjernen-macos-arm64.dmg     'macos/*/*-macos-arm64.dmg'
    link_stable nordstjernen-macos-x86_64.dmg    'macos/*/*-macos-x86_64.dmg'
    link_stable nordstjernen-macos.dmg           'macos/*/*-macos-x86_64.dmg'
