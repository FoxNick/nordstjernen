...
**HTML Standards:** Behaviour is measured against the spec text, section by section, not against another browser — 122 spec rows fully implemented, 41 partial, 4 absent as of June 2026. 
...
records **122 spec rows fully implemented, 41 partial, and 4 absent**
