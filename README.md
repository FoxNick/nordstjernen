...
**HTML Standards:** Behaviour is measured against the spec text, section by section, not against another browser — 121 spec rows fully implemented, 42 partial, 4 absent as of June 2026. 
...
records **121 spec rows fully implemented, 42 partial, and 4 absent**
