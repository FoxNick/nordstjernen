...
**HTML Standards:** Behaviour is measured against the spec text, section by section, not against another browser — 124 spec rows fully implemented, 39 partial, 4 absent as of June 2026. 
...
records **124 spec rows fully implemented, 39 partial, and 4 absent**
