...
**HTML Standards:** Behaviour is measured against the spec text, section by section, not against another browser — 135 spec rows fully implemented, 28 partial, 4 absent as of June 2026. 
...
records **135 spec rows fully implemented, 28 partial, and 4 absent**
...
| §10 Web workers — dedicated workers (incl. `fetch`/`Request`/`Response`, `crypto.subtle`, transferable `ArrayBuffer`s), minimalist Service Workers, working Cache API; SW network interception pending | 🟡 |
...
| Platform | Download |
|----------|----------|
| Windows | [Windows store](https://apps.microsoft.com/detail/9nw8t7w5z4pl) - [`nordstjernen-windows-x86_64.zip`](https://www.nordstjernen.org/nightly/nordstjernen-windows-x86_64.zip)  |
