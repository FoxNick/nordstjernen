...
**HTML Standards:** Behaviour is measured against the spec text, section by section, not against another browser — 132 spec rows fully implemented, 31 partial, 4 absent as of June 2026. 
...
records **132 spec rows fully implemented, 31 partial, and 4 absent**
