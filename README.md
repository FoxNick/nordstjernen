...
**HTML Standards:** Behaviour is measured against the spec text, section by section, not against another browser — 131 spec rows fully implemented, 32 partial, 4 absent as of June 2026. 
...
records **131 spec rows fully implemented, 32 partial, and 4 absent**
