...
**HTML Standards:** Behaviour is measured against the spec text, section by section, not against another browser — 115 spec rows fully implemented, 48 partial, 4 absent as of June 2026. 
...
records **115 spec rows fully implemented, 48 partial, and 4 absent**
